import { createPayment, deletePayment, listInvoicePayments, } from "./payment.service.js";
import { createPaymentSchema, invoicePaymentsParamsSchema, paymentIdSchema, } from "./payment.schema.js";
...
export async function listInvoicePaymentsHandler(request, response, next) {
    try {
...
export async function deletePaymentHandler(request, response, next) {
    try {
