...
import { deleteReceiptHandler, downloadReceiptHandler, extractReceiptHandler, listExpenseReceiptsHandler, uploadReceiptHandler, } from "./receipt.controller.js";
import { receiptUpload } from "./receipt.upload.js";
export const receiptRouter = Router();
receiptRouter.post("/expense/:expenseId", receiptUpload.single("receipt"), uploadReceiptHandler);
