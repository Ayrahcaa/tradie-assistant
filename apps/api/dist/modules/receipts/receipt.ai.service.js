...
`;
    ...
    const fileContent = receipt.mimeType === "application/pdf"
        ? {
            type: "input_file",
    ...
    const response = await openai.responses.parse({
        ...
        input: [
            {
                role: "system",
                content: "You are an accurate Australian receipt data extraction assistant.",
            },
            {
                role: "user",
                content: [
...
//# sourceMappingURL=receipt.ai.service.js.map