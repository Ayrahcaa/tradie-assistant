import assert from "node:assert/strict";import test from "node:test";import{cashAttributedGst,expenseGstCreditTotal,gstExclusive,gstForTreatment,gstInclusive,invoiceGstTotal,moneyPosition,projectPosition,residentIncomeTax,suggestedReserve,variance}from"./financial-calculations.js";
