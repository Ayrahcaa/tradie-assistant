...
import {
  ...
  deleteSubcontractorHandler,
  getSubcontractorHandler,
  listSubcontractorsHandler,
  restoreSubcontractorHandler,
  updateSubcontractorHandler,
} from "./subcontractor.controller.js";
...
subcontractorRouter.patch(
  "/:subcontractorId/archive",
  archiveSubcontractorHandler,
);

subcontractorRouter.patch(
  "/:subcontractorId/restore",
  restoreSubcontractorHandler,
);
