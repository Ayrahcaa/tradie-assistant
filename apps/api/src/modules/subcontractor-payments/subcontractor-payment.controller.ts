...
import {
  ...
  subcontractorPaymentIdSchema,
} from "./subcontractor-payment.schema.js";

import {
  createSubcontractorPayment,
  deleteSubcontractorPayment,
} from "./subcontractor-payment.service.js";

export async function createSubcontractorPaymentHandler(
  request: Request,
  response: Response,
  next: NextFunction,
): Promise<void> {
...
export async function deleteSubcontractorPaymentHandler(
  request: Request,
  response: Response,
  next: NextFunction,
): Promise<void> {
