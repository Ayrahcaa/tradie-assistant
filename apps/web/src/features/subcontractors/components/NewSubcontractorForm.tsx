...
export function NewSubcontractorForm({
  ...
  function buildPayload(): CreateSubcontractorInput {
    return {
      ...
      <div className="space-y-5 p-6">
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleChange}
            rows={4}
            placeholder="Electrician used for residential projects."
